...
public class QuickSortAnyPivot {

    public static void quickSort(int[] arr, int low, int high) {
        if (low < high) {
            // You can change pivot selection logic here
    ...
    // Change this method to test different pivot strategies
    private static int choosePivot(int[] arr, int low, int high) {
        // return low;                     // First element
        // return high;                    // Last element
        // return (low + high) / 2;        // Middle element
        return low + (int)(Math.random() * (high - low + 1)); // Random
    }
